...
export const assetSymbols: AssetSymbol[] = [
  { id: 'a1', symbol: 'EURUSD', description: 'Euro vs US Dollar', category: 'Currencies', calcType: 'Forex', groupName: 'Major', spreadBid: 0.00010, spreadAsk: 0.00010, stopLevel: 20, gapLevel: 10, swapLong: -3.50, swapShort: 1.20, tradingAllowed: true, contractSize: 100000, marginPercent: 1, precision: 5, hedgeMargin: 50, spreadType: 'Variable', marginCurrency: 'EUR', profitCurrency: 'USD', commission: 0, bid: 1.08542, ask: 1.08562, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a2', symbol: 'GBPUSD', description: 'British Pound vs US Dollar', category: 'Currencies', calcType: 'Forex', groupName: 'Major', spreadBid: 0.00015, spreadAsk: 0.00015, stopLevel: 25, gapLevel: 12, swapLong: -4.20, swapShort: 0.80, tradingAllowed: true, contractSize: 100000, marginPercent: 1, precision: 5, hedgeMargin: 50, spreadType: 'Variable', marginCurrency: 'GBP', profitCurrency: 'USD', commission: 0, bid: 1.26340, ask: 1.26370, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a3', symbol: 'USDJPY', description: 'US Dollar vs Japanese Yen', category: 'Currencies', calcType: 'Forex', groupName: 'Major', spreadBid: 0.010, spreadAsk: 0.010, stopLevel: 20, gapLevel: 10, swapLong: 2.10, swapShort: -5.30, tradingAllowed: true, contractSize: 100000, marginPercent: 1, precision: 3, hedgeMargin: 50, spreadType: 'Variable', marginCurrency: 'USD', profitCurrency: 'JPY', commission: 0, bid: 151.234, ask: 151.254, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a4', symbol: 'XAUUSD', description: 'Gold vs US Dollar', category: 'Commodities', calcType: 'CFD', groupName: 'Metals', spreadBid: 0.30, spreadAsk: 0.30, stopLevel: 50, gapLevel: 25, swapLong: -8.50, swapShort: 2.10, tradingAllowed: true, contractSize: 100, marginPercent: 2, precision: 2, hedgeMargin: 50, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 5, bid: 3024.50, ask: 3025.10, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a5', symbol: 'BTCUSD', description: 'Bitcoin vs US Dollar', category: 'Crypto', calcType: 'Crypto', groupName: 'Crypto Major', spreadBid: 50, spreadAsk: 50, stopLevel: 500, gapLevel: 200, swapLong: -15.00, swapShort: -15.00, tradingAllowed: true, contractSize: 1, marginPercent: 10, precision: 2, hedgeMargin: 100, spreadType: 'Variable', marginCurrency: 'USD', profitCurrency: 'USD', commission: 10, bid: 87250.00, ask: 87350.00, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a6', symbol: 'ETHUSD', description: 'Ethereum vs US Dollar', category: 'Crypto', calcType: 'Crypto', groupName: 'Crypto Major', spreadBid: 3, spreadAsk: 3, stopLevel: 50, gapLevel: 20, swapLong: -12.00, swapShort: -12.00, tradingAllowed: true, contractSize: 1, marginPercent: 10, precision: 2, hedgeMargin: 100, spreadType: 'Variable', marginCurrency: 'USD', profitCurrency: 'USD', commission: 5, bid: 3420.00, ask: 3426.00, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a7', symbol: 'AAPL', description: 'Apple Inc.', category: 'US Stocks', calcType: 'CFD', groupName: 'US Tech', spreadBid: 0.05, spreadAsk: 0.05, stopLevel: 10, gapLevel: 5, swapLong: -2.50, swapShort: -0.50, tradingAllowed: true, contractSize: 1, marginPercent: 5, precision: 2, hedgeMargin: 100, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 2, bid: 178.45, ask: 178.55, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a8', symbol: 'TSLA', description: 'Tesla Inc.', category: 'US Stocks', calcType: 'CFD', groupName: 'US Tech', spreadBid: 0.10, spreadAsk: 0.10, stopLevel: 15, gapLevel: 8, swapLong: -3.00, swapShort: -1.00, tradingAllowed: true, contractSize: 1, marginPercent: 5, precision: 2, hedgeMargin: 100, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 2, bid: 245.30, ask: 245.50, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a9', symbol: 'US500', description: 'S&P 500 Index', category: 'Indices', calcType: 'CFD', groupName: 'Indices', spreadBid: 0.50, spreadAsk: 0.50, stopLevel: 30, gapLevel: 15, swapLong: -5.00, swapShort: 1.00, tradingAllowed: true, contractSize: 10, marginPercent: 2, precision: 2, hedgeMargin: 50, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 3, bid: 5780.50, ask: 5781.50, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a10', symbol: 'XAGUSD', description: 'Silver vs US Dollar', category: 'Commodities', calcType: 'CFD', groupName: 'Metals', spreadBid: 0.02, spreadAsk: 0.02, stopLevel: 30, gapLevel: 15, swapLong: -4.00, swapShort: 0.80, tradingAllowed: true, contractSize: 5000, marginPercent: 3, precision: 3, hedgeMargin: 50, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 3, bid: 33.450, ask: 33.490, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a11', symbol: 'USDCHF', description: 'US Dollar vs Swiss Franc', category: 'Currencies', calcType: 'Forex', groupName: 'Major', spreadBid: 0.00012, spreadAsk: 0.00012, stopLevel: 20, gapLevel: 10, swapLong: 1.80, swapShort: -4.50, tradingAllowed: true, contractSize: 100000, marginPercent: 1, precision: 5, hedgeMargin: 50, spreadType: 'Variable', marginCurrency: 'USD', profitCurrency: 'CHF', commission: 0, bid: 0.88120, ask: 0.88144, lastUpdated: '2026-03-31T12:00:00', isActive: true },
  { id: 'a12', symbol: 'GOOGL', description: 'Alphabet Inc.', category: 'US Stocks', calcType: 'CFD', groupName: 'US Tech', spreadBid: 0.08, spreadAsk: 0.08, stopLevel: 12, gapLevel: 6, swapLong: -2.80, swapShort: -0.60, tradingAllowed: true, contractSize: 1, marginPercent: 5, precision: 2, hedgeMargin: 100, spreadType: 'Fixed', marginCurrency: 'USD', profitCurrency: 'USD', commission: 2, bid: 165.20, ask: 165.36, lastUpdated: '2026-03-31T12:00:00', isActive: true },
];
