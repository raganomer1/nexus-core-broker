...
import platformKyc from "@/assets/platform-kyc.jpg";
import platformSupport from "@/assets/platform-support.jpg";
...
const featureKeys: { icon: typeof LayoutDashboard; titleKey: WebsiteTranslationKey; descKey: WebsiteTranslationKey; itemKeys: WebsiteTranslationKey[]; image?: string }[] = [
  ...
  { icon: Shield, titleKey: "platPageKYCTitle", descKey: "platPageKYCDesc", itemKeys: ["platPageKYCF1", "platPageKYCF2", "platPageKYCF3", "platPageKYCF4"], image: platformKyc },
  { icon: Headphones, titleKey: "platPageSupportTitle", descKey: "platPageSupportDesc", itemKeys: ["platPageSupportF1", "platPageSupportF2", "platPageSupportF3", "platPageSupportF4"], image: platformSupport },
];
