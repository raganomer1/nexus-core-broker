    ...
    <section className="py-24 md:py-32 bg-website-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSection className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">{w("ctaTitle")}</h2>
          <p className="text-lg text-gray-400 mb-10 leading-relaxed">{w("ctaDesc")}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contacts">
              <Button size="lg" variant="outline" className="text-base px-8 border-white/20 text-white bg-white/5 hover:bg-white/10">
                {w("ctaContact")}
              </Button>
            </Link>
          </div>
